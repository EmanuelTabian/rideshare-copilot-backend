...
class CarPostSerializer(serializers.ModelSerializer):
    class Meta:
        model = CarPost
        fields = ['id' ,'image','created_at','car_name','model', 'version', 'year', 'engine', 'fuel', 'body', 'transmission', "gear_number", 'color', 'seat_number', 'door_number', 'milleage', 'power', 'mpg','description', 'emission_standard', 'location', 'phone_number', 'price']
