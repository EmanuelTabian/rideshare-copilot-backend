...
class CalculatorEntry(models.Model):
    ...
    commission = models.DecimalField(
        "Commission", max_digits=10, decimal_places=2, null=True, blank=True
    )
    expenses = models.DecimalField(
        "Expenses", max_digits=10, decimal_places=2, null=True, blank=True
    )
    earnings = models.DecimalField(
        "Earnings", max_digits=10, decimal_places=2, null=True, blank=True
    )
